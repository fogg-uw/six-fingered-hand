...
D0a_ex should always be 0.
```{r, }
dat[which(dat$D0a_ex > 0), c(1,4:10,13:21,37:42)]
```
3 problems: jobs 117 (2), 141 (1), 144 (1).
Very rare: 3 out of 16294+13526+14293 = 44113 four-taxon sets in these 3 jobs,
...
from simulations, the naive way.
...
ggsave("fig_prob_anomalous12_ex.pdf", height=4.5, width=7)
```
